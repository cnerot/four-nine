...
<head>
  ...
  <body class="grey darken-2">
    <ul id="dropdown1" class="dropdown-content grey darken-4 ">
        <li><a href="<?php echo Router::getUrl("Concours","New");?>"> <span class="yellow-text text-darken-2">Créer un concour</span></a></li>
        <li><a href="<?php echo Router::getUrl("Concours","index");?>"><span class="yellow-text text-darken-2">Gestion des concours</span></a></li>
        <li class="divider"><span class="yellow-text text-darken-2"></span></li>
        <li><a href="<?php echo Router::getUrl("Admin","index");?>"><span class="yellow-text text-darken-2">Pages statiques</span></a></li>
    </ul>
        ...
        <div class="nav-wrapper grey darken-4">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    <li><a class="dropdown-button" href="#!" data-activates="dropdown1"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Administrateur<span><i class="material-icons right">arrow_drop_down</i></a></li>
                </ul>
