        ...
        <div class="section no-pad-bot">
          <div class="container">
            ...
            <div class="row center">
              ...
              <a href="<?php echo Router::getUrl("Vote","vote");?>" id="download-button" class="btn-large waves-effect waves-light black-text  yellow lighten-1">Je vote <i class="material-icons right">play_arrow</i></a>
            </div>
            <br><br>
